...
import 'package:banksatu_mobile/core/widgets/custom_bottom_nav.dart';
import 'package:banksatu_mobile/features/dashboard/presentation/dashboard_screen.dart';
import 'package:banksatu_mobile/features/dashboard/presentation/transaction_detail_screen.dart';
import 'package:banksatu_mobile/features/security/presentation/security_screen.dart';
import 'package:banksatu_mobile/features/subscriptions/presentation/subscription_screen.dart';
import 'package:banksatu_mobile/features/syariah/presentation/syariah_screen.dart';
import 'package:banksatu_mobile/features/future_rails/presentation/future_rails_screen.dart';
import 'package:banksatu_mobile/features/onboarding/presentation/onboarding_screen.dart';
import 'package:banksatu_mobile/features/onboarding/presentation/kyc_identity_screen.dart';
import 'package:banksatu_mobile/features/onboarding/presentation/kyc_face_screen.dart';
import 'package:banksatu_mobile/features/onboarding/presentation/kyc_success_screen.dart';
import 'package:banksatu_mobile/features/auth/presentation/oauth_login_screen.dart';
import 'package:banksatu_mobile/features/auth/presentation/login_screen.dart';
import 'package:banksatu_mobile/features/profile/presentation/profile_screen.dart';
import 'package:banksatu_mobile/features/transactions/presentation/transfer_screen.dart';
import 'package:banksatu_mobile/features/transactions/presentation/pay_bills_screen.dart';
import 'package:banksatu_mobile/features/transactions/presentation/pln_detail_screen.dart';
import 'package:banksatu_mobile/features/transactions/presentation/qris_scan_screen.dart';
import 'package:banksatu_mobile/features/transactions/presentation/bill_split_screen.dart';
import 'package:banksatu_mobile/features/transactions/presentation/scheduled_transfer_screen.dart';
import 'package:banksatu_mobile/features/wealth/presentation/invest_screen.dart';
import 'package:banksatu_mobile/features/wealth/presentation/portfolio_screen.dart';
import 'package:banksatu_mobile/features/wealth/presentation/time_deposit_screen.dart';
import 'package:banksatu_mobile/features/wealth/presentation/shared_vault_screen.dart';
import 'package:banksatu_mobile/features/wealth/presentation/roundup_screen.dart';
import 'package:banksatu_mobile/features/wealth/presentation/roundup_instruments_screen.dart';
import 'package:banksatu_mobile/features/analytics/presentation/ai_assistant_screen.dart';
import 'package:banksatu_mobile/features/analytics/presentation/ai_assistant_search_screen.dart';
import 'package:banksatu_mobile/features/analytics/presentation/ai_financial_insights_screen.dart';
import 'package:banksatu_mobile/features/analytics/presentation/transaction_intelligence_screen.dart';
import 'package:banksatu_mobile/features/analytics/presentation/notification_intelligence_screen.dart';
import 'package:banksatu_mobile/features/analytics/presentation/widget_quick_actions_screen.dart';
import 'package:banksatu_mobile/features/sme/presentation/sme_dashboard_screen.dart';
import 'package:banksatu_mobile/features/sme/presentation/sme_new_invoice_screen.dart';
import 'package:banksatu_mobile/features/sme/presentation/programmable_money_detail_screen.dart';
import 'package:banksatu_mobile/features/sme/presentation/programmable_money_verify_screen.dart';
import 'package:banksatu_mobile/features/sme/presentation/programmable_money_rejected_screen.dart';
import 'package:banksatu_mobile/features/accessibility/presentation/accessibility_settings_screen.dart';
import 'package:banksatu_mobile/features/accessibility/presentation/theme_customizer_screen.dart';
import 'package:banksatu_mobile/features/accessibility/presentation/biometrics_setup_screen.dart';
import 'package:banksatu_mobile/features/accessibility/presentation/language_selector_screen.dart';
import 'package:banksatu_mobile/features/accessibility/presentation/security_logs_screen.dart';
import 'package:banksatu_mobile/features/dashboard/presentation/loyalty_screen.dart';
import 'package:banksatu_mobile/features/dashboard/presentation/system_status_screen.dart';
import 'package:banksatu_mobile/features/wealth/presentation/multicurrency_wallet_screen.dart';
import 'package:banksatu_mobile/features/wealth/presentation/live_fx_rate_screen.dart';
import 'package:banksatu_mobile/features/wealth/presentation/financial_products_screen.dart';
import 'package:banksatu_mobile/features/security/presentation/card_limit_settings_screen.dart';
import 'package:banksatu_mobile/features/wealth/presentation/shared_wallet_screen.dart';
import 'package:banksatu_mobile/features/profile/presentation/customer_service_screen.dart';
import 'package:banksatu_mobile/features/dashboard/presentation/lifestyle_marketplace_screen.dart';
import 'package:banksatu_mobile/features/dashboard/presentation/notification_center_screen.dart';
import 'package:banksatu_mobile/features/security/presentation/digital_heir_screen.dart';
import 'package:banksatu_mobile/features/security/presentation/dispute_manager_screen.dart';
import 'package:banksatu_mobile/features/security/presentation/virtual_card_screen.dart';
import 'package:banksatu_mobile/features/security/presentation/credit_card_screen.dart';
import 'package:banksatu_mobile/features/security/presentation/personal_api_screen.dart';
import 'package:banksatu_mobile/features/transactions/presentation/bulk_transfer_screen.dart';
import 'package:banksatu_mobile/features/security/presentation/device_management_screen.dart';
import 'package:banksatu_mobile/features/dashboard/presentation/sub_account_management_screen.dart';
import 'package:banksatu_mobile/features/transactions/presentation/payment_link_screen.dart';
import 'package:banksatu_mobile/features/transactions/presentation/request_money_screen.dart';
import 'package:banksatu_mobile/features/security/presentation/travel_mode_screen.dart';
import 'package:banksatu_mobile/features/dashboard/presentation/envelope_budgeting_screen.dart';
import 'package:banksatu_mobile/features/subscriptions/presentation/recurring_payments_screen.dart';
import 'package:banksatu_mobile/features/dashboard/presentation/export_report_screen.dart';
import 'package:banksatu_mobile/features/analytics/presentation/financial_health_screen.dart';
import 'package:banksatu_mobile/features/analytics/presentation/tax_report_screen.dart';
import 'package:banksatu_mobile/features/analytics/presentation/predictive_cashflow_screen.dart';
import 'package:banksatu_mobile/features/analytics/presentation/geolocation_map_screen.dart';
import 'package:banksatu_mobile/features/wealth/presentation/group_savings_screen.dart';
import 'package:banksatu_mobile/features/sme/presentation/approval_workflow_screen.dart';
import 'package:banksatu_mobile/features/transactions/presentation/contact_history_screen.dart';
import 'package:banksatu_mobile/features/accessibility/presentation/voice_banking_screen.dart';
import 'package:banksatu_mobile/features/accessibility/presentation/elder_mode_screen.dart';
import 'package:banksatu_mobile/features/security/presentation/duress_pin_screen.dart';
